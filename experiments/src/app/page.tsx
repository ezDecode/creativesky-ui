      ...
      >
        ...
        <motion.section variants={itemVariants} className="flex flex-col gap-6 sm:gap-8 tracking-normal">
          ...
          <p className="text-subheading font-medium text-foreground max-w-2xl">
            A small lab of interactive UI experiments and reusable components.
          </p>

          <p className="max-w-2xl text-body leading-relaxed text-muted-foreground">
            Explore curated demos, view source, or <Link href="https://github.com/ezdecode/experiments" className="text-body-emphasis underline underline-offset-4">contribute</Link>. For suggestions or feedback, <Link href="mailto:ezdecode@gmail" className="text-body-emphasis underline underline-offset-4">reach out</Link>.
          </p>
        </motion.section>
