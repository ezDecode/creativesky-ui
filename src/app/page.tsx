        ...
        <section className="flex flex-col gap-8 sm:gap-10 tracking-normal">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <h1 className="text-3xl sm:text-5xl font-bold tracking-tight text-foreground bg-gradient-to-br from-foreground to-muted-foreground/60 bg-clip-text text-transparent pb-1">
                Akash
              </h1>
          ...
          <div className="space-y-6 max-w-3xl">
            <p className="text-2xl sm:text-3xl font-light text-foreground leading-snug">
              ...
              Enter the <Link href="/lab" className="group font-medium text-foreground underline decoration-muted-foreground/30 underline-offset-4 transition-all hover:decoration-primary hover:text-primary relative inline-flex items-center gap-1">
                lab
            ...
            <div className="flex items-center gap-6 pt-4">
              <Link href="mailto:ezdecode@gmail.com" className="group flex items-center gap-2 text-sm font-medium text-foreground/80 transition-colors hover:text-foreground">
        ...
        {featuredComponents.length > 0 && (
          <section className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
            <div className="flex items-center justify-between border-b border-border/10 pb-4">
              <h2 className="text-sm font-medium text-muted-foreground uppercase tracking-widest">Featured Experiments</h2>
              <Link href="/lab" className="text-sm text-foreground/60 hover:text-foreground transition-colors flex items-center gap-1 group">
                View all
