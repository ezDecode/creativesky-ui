          ...
          <section className="flex flex-col gap-8 sm:gap-10 tracking-normal">
            ...
            <div className="space-y-6 max-w-3xl">
              <p className="text-2xl sm:text-3xl font-light text-foreground leading-snug">
                ...
                Enter the <Link href="/craft" className="group font-medium text-foreground underline decoration-muted-foreground/30 underline-offset-4 transition-all hover:decoration-primary hover:text-primary relative inline-flex items-center gap-1">
                  craft
