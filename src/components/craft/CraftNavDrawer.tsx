...
export function CraftNavDrawer({ components, trigger }: CraftNavDrawerProps) {
    ...
    return (
        <Drawer open={open} onOpenChange={setOpen} direction="bottom">
            ...
            <DrawerContent className="bottom-8 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] max-w-lg bg-background/80 backdrop-blur-xl border border-border/50 rounded-[2rem] shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-300">
