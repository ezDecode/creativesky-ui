...
export function ComponentPreview({
  ...
  const { showCode, setShowCode, isFullscreen, setIsFullscreen, isDrawerOpen, setIsDrawerOpen } = useCraftPage();
    ...
    >
      ...
      <motion.div 
        ...
        className={cn(
          ...
          isFullscreen ? "fixed inset-4 z-[101] bg-muted shadow-2xl border border-border/50" : "bg-muted/50"
        )}
      >
        <CraftNavDrawer
        ...
        {/* Render dock in fullscreen mode to allow exit */}
        {isFullscreen && (
          <PreviewDock
